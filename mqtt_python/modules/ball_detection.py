...
def pose_est_ball_from_img(image, Ball_Color = Ball_Color.BLUE, undistort = False, show = False):
	"""
	...
	if undistort:
		poses = [pose_estimation_ball2(detection, MTX, DIST) for detection in detections if detection is not None]
	else:
